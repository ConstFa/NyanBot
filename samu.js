...
const owner = ["51978048374@s.whatsapp.net"]
...
"businessOwnerJid": `"51978048374@s.whatsapp.net"`
}
}}})
await sleep(4000)
...
samu330.on('chat-update', async(sam) => {
	...
	mess = {
			...
			only: {
    			...
    			ownerB: '[❗] ¡Este comando solo puede ser utilizado por el creador del bot! ❌\nOsea, Samu: wa.me/+51978048374, Habla con el para que pueda cambiar el numero del owner en este bot',
...
redes = ['*Sigueme y te sigo en instagram!* https://www.instagram.com/fabri_12_1406']
...
const forder = { key : {fromMe: false,participant : "0@s.whatsapp.net", ...(from ? { remoteJid: "status@broadcast" } : {})},message: {orderMessage: {itemCount : 999999999,status: 1,surface : 1,message: `🥀𝐒𝐚𝐦𝐮𝟑𝟑𝟎 | 𝑁𝑦𝑎𝑛𝐵𝑜𝑡🍒`,orderTitle: 'Samu330',sellerJid: `𝗡𝘆𝗮𝗻𝗕𝗼𝘁🌱`,thumbnail: fs.readFileSync('./src/fake.jpg')}}}
...
${samu} 🏆Numero del Dueño wa.me/+978048374${samu}

𝗠𝗬 𝗖𝗔𝗡𝗔𝗟 𝗗𝗘 𝗬𝗢𝗨𝗧𝗨.𝗕𝗘: https://www.youtube.com/channel/UCFqkpNXw5czZjiWCQ-pph5A
...
case 'pregunta':
respuesta = ['Si', 'No', 'Tal vez', 'Puede ser', 'Ai una probabilidad del 99.99999999991.01%', 'Puede que no', 'Yo que se', 'mmmm🤔.... Dejame lo pienso un poco', 'Joder si', 'NOO',]
...
case 'crash':
if (!isOwner) return reply('*JAJA y este we quien es??*')
...
case 'update':
if (!itsMe) return reply('tu quien eres para decirme que hacer!?🤔')
reply('*ESPERE UN MOMENTO... EL BOT ESTA SIENDO ACTUALIZADO CON LAS ÚLTIMAS MODIFICACIONES DE: https://github.com/ConstFa/NyanBot*')
exec(`bash update.sh`, (err, stdout) => {
if (err) return reply(err)
if (stdout) reply(`*El bot se ha actualizado de forma satisfactoria*\n Informe de la actualización:\n\n${stdout}\n\nLos cambios se mostraran despues de volver a iniciar el bot!.`)
})
break
...
samu330.sendMessage('51978048374@s.whatsapp.net', options, MessageType.text, {quoted: floc})
...
case 'ipbot':
if (!isOwner) return reply('Este comando solo puede ser usado por El owner del bot')
...

/*////*/case 'igstalk':
/*////*/if (!q) return reply(`*Y el nombre de usuario??* ejemplo de uso: ${prefix}igstalk fabri_12_1406`)
...
case 'spam':
if (!isOwner) return reply('Este comando es solo para 🐉Samu330🪀')
arg1 = q
...
case 'owner':
case 'creador':
await wa.sendContact(from, '51978048374', "༺ᠻꪖꪉꪹỉ࿐⃝➳♡⃤")
break
...
case 'exif':
if (!itsOwner) return reply('Este comando solo puede ser usado por *Samu330* ⚙')
...
case 'setstatus':
if (!isOwner) return reply('Este comando solo puede ser usado por *Samu330* ⚙')
...
break
case 'estado':
if (!isAdmin) return reply('Este comando solo puede ser usado por *Samu330* ⚙')
...
break
case 'link':
if (!isOwner && !itsMe && !isAdmin) return await reply('Este comando solo puede ser usado por *Samu330* ⚙')
addFilter(from)
...
default:
if (body.startsWith(">")) {
if (!isOwner) return await reply('Este comando solo puede ser usado por *Samu330* ⚙')
